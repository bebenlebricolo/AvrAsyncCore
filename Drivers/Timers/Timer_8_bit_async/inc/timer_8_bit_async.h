...
/**
 * @brief Resets internal configuration of timer 8 bit async driver
 */
 ...
 */
extern timer_8_bit_async_handle_t timer_8_bit_async_static_handle[TIMER_8_BIT_ASYNC_COUNT];

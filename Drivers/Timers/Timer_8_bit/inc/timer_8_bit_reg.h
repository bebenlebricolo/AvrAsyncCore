...
typedef struct
{
    ...
    timer_8_bit_compare_output_mode_t comp_match_a;     /**< Describes the kind of compare match behavior ; equivalent to TCCRnA COMnA0 and COMnA1 bits */
    timer_8_bit_compare_output_mode_t comp_match_b;     /**< Describes the kind of compare match behavior ; equivalent to TCCRnA COMnB0 and COMnB1 bits */
